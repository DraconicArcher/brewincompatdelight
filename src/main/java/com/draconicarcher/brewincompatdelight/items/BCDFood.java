...
public class BCDFood {
    ...
    public static final FoodProperties HALF_AND_HALF = (new Builder()).effect(() -> {
        return new MobEffectInstance(FREffects.CAFFEINATED.get(), 600, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(ModEffects.COMFORT.get(), 600, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(MobEffects.DIG_SPEED, 600, 0);
    }, 1.0F).alwaysEat().build();
    public static final FoodProperties BLACK_RUSSIAN = (new Builder()).effect(() -> {
        return new MobEffectInstance(BnCEffects.TIPSY.get(), 2400, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(FREffects.CAFFEINATED.get(), 6000, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(BnCEffects.INTOXICATION.get(), 1800, 0);
    }, 1.0F).alwaysEat().build();
    public static final FoodProperties WHITE_RUSSIAN = (new Builder()).effect(() -> {
        return new MobEffectInstance(BnCEffects.TIPSY.get(), 2400, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(FREffects.CAFFEINATED.get(), 6000, 0);
    }, 1.0F).effect(() -> {
    ...
    public static final FoodProperties SCREWDRIVER = (new Builder()).effect(() -> {
        return new MobEffectInstance(BnCEffects.TIPSY.get(), 2400, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(FDEffects.LEAF_PIERCING.get(), 600, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(BnCEffects.INTOXICATION.get(), 1800, 0);
    }, 1.0F).alwaysEat().build();
    ...
    public static final FoodProperties MULLED_WINE = (new Builder()).effect(() -> {
        return new MobEffectInstance(BnCEffects.TIPSY.get(), 2400, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(BCDModEffects.ARROW_LOOTING.get(), 1200, 0);
    }, 1.0F).effect(() -> {
    ...
    public static final FoodProperties PEACH_WINE = (new Builder()).effect(() -> {
        return new MobEffectInstance(BnCEffects.TIPSY.get(), 1800, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(FDEffects.HEAL_AURA.get(), 1200, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(BCDModEffects.ARROW_LOOTING.get(), 1200, 0);
    }, 1.0F).effect(() -> {
    ...
    public static final FoodProperties MOJITO = (new Builder()).effect(() -> {
        return new MobEffectInstance(BnCEffects.TIPSY.get(), 1200, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 600, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(CREffects.CORROSION.get(), 300, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(BnCEffects.INTOXICATION.get(), 900, 0);
    }, 1.0F).alwaysEat().build();
    ...
    public static final FoodProperties LEMON_LIME = (new Builder()).effect(() -> {
        return new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 0);
    }, 1.0F).effect(() -> {
        return new MobEffectInstance(CREffects.CORROSION.get(), 1200, 0);
    }, 1.0F).alwaysEat().build();
