...
public class Brewincompatdelight {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS) {
            ...
            addItemToTab(event, BCDItems.HOT_TODDY);
            addItemToTab(event, BCDItems.MULLED_CIDER);
            addItemToTab(event, BCDItems.MINT_JULEP);
            addItemToTab(event, BCDItems.BLACK_CUBAN);
